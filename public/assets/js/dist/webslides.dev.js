  ...
  var DOM = function () {
    ...
    _createClass(DOM, null, [{
      ...
      value: function fireEvent(target, eventType) {
        ...
        var event = new __WEBPACK_IMPORTED_MODULE_0__custom_event__["a"
        /* default */
        ](eventType, {
          detail: eventInfo
        });
...
function (module, __webpack_exports__, __webpack_require__) {
  ...
  var Slide = function () {
    ...
    _createClass(Slide, [{
      key: 'hide',
      value: function hide() {
        __WEBPACK_IMPORTED_MODULE_0__utils_dom__["a"
        /* default */
        ].hide(this.el);
...
function (module, __webpack_exports__, __webpack_require__) {
  ...
  function scrollTo(y) {
    ...
    var animateScroll = function animateScroll(elapsedTime) {
      ...
      var easingP = __WEBPACK_IMPORTED_MODULE_0__easing__["a"
      /* default */
...
function (module, __webpack_exports__, __webpack_require__) {
  ...
  window.WebSlides = __WEBPACK_IMPORTED_MODULE_0__modules_webslides__["a"
  /* default */
  ];
  /***/
},
...
function (module, __webpack_exports__, __webpack_require__) {
  ...
  var PLUGINS = {
    'autoslide': __WEBPACK_IMPORTED_MODULE_0__plugins_plugins__["a"
    /* default */
    ].AutoSlide,
    'clickNav': __WEBPACK_IMPORTED_MODULE_0__plugins_plugins__["a"
    /* default */
    ].ClickNav,
    'grid': __WEBPACK_IMPORTED_MODULE_0__plugins_plugins__["a"
    /* default */
    ].Grid,
    'hash': __WEBPACK_IMPORTED_MODULE_0__plugins_plugins__["a"
    /* default */
    ].Hash,
    'keyboard': __WEBPACK_IMPORTED_MODULE_0__plugins_plugins__["a"
    /* default */
    ].Keyboard,
    'nav': __WEBPACK_IMPORTED_MODULE_0__plugins_plugins__["a"
    /* default */
    ].Navigation,
    'scroll': __WEBPACK_IMPORTED_MODULE_0__plugins_plugins__["a"
    /* default */
    ].Scroll,
    'touch': __WEBPACK_IMPORTED_MODULE_0__plugins_plugins__["a"
    /* default */
    ].Touch,
    'video': __WEBPACK_IMPORTED_MODULE_0__plugins_plugins__["a"
    /* default */
    ].Video,
    'youtube': __WEBPACK_IMPORTED_MODULE_0__plugins_plugins__["a"
    /* default */
    ].YouTube,
    'zoom': __WEBPACK_IMPORTED_MODULE_0__plugins_plugins__["a"
    /* default */
    ].Zoom
  };
  /**
    ...
    _createClass(WebSlides, [{
      ...
      value: function removeChildren_() {
        ...
        while (i--) {
          ...
          if (!__WEBPACK_IMPORTED_MODULE_1__slide__["b"
          /* default */
          ].isCandidate(node)) {
      ...
      value: function onInit_() {
        ...
        __WEBPACK_IMPORTED_MODULE_2__utils_dom__["a"
        /* default */
      ...
      value: function grabSlides_() {
        this.slides = __WEBPACK_IMPORTED_MODULE_2__utils_dom__["a"
        /* default */
        ].toArray(this.el.childNodes).map(function (slide, i) {
          return new __WEBPACK_IMPORTED_MODULE_1__slide__["b"
          /* default */
          ](slide, i);
        });
      ...
      value: function scrollTransitionToSlide_(isMovingForward, nextSlide, callback) {
        ...
        if (!isMovingForward) {
          ...
          nextSlide.show();
          Object(__WEBPACK_IMPORTED_MODULE_3__utils_scroll_to__["a"
          /* default */
      ...
      value: function transitionToSlide_(isMovingForward, nextSlide, callback) {
        ...
        if (this.initialised && this.plugins.touch && this.plugins.touch.isEnabled) {
          __WEBPACK_IMPORTED_MODULE_2__utils_dom__["a"
          /* default */
          ].once(nextSlide.el, __WEBPACK_IMPORTED_MODULE_2__utils_dom__["a"
          /* default */
...
function (module, __webpack_exports__, __webpack_require__) {
  ...
  __webpack_exports__["a"] = {
    AutoSlide: __WEBPACK_IMPORTED_MODULE_0__autoslide__["a"
    /* default */
    ],
    ClickNav: __WEBPACK_IMPORTED_MODULE_1__click_nav__["a"
    /* default */
    ],
    Grid: __WEBPACK_IMPORTED_MODULE_2__grid__["a"
    /* default */
    ],
    Hash: __WEBPACK_IMPORTED_MODULE_3__hash__["a"
    /* default */
    ],
    Keyboard: __WEBPACK_IMPORTED_MODULE_4__keyboard__["a"
    /* default */
    ],
    Navigation: __WEBPACK_IMPORTED_MODULE_5__navigation__["a"
    /* default */
    ],
    Scroll: __WEBPACK_IMPORTED_MODULE_6__scroll__["a"
    /* default */
    ],
    Touch: __WEBPACK_IMPORTED_MODULE_7__touch__["a"
    /* default */
    ],
    Video: __WEBPACK_IMPORTED_MODULE_8__video__["a"
    /* default */
    ],
    YouTube: __WEBPACK_IMPORTED_MODULE_9__youtube__["a"
    /* default */
    ],
    Zoom: __WEBPACK_IMPORTED_MODULE_10__zoom__["a"
    /* default */
    ]
  };
  /***/
  ...
  var AutoSlide = function () {
    ...
    _createClass(AutoSlide, [{
      ...
      value: function onFocus() {
        if (__WEBPACK_IMPORTED_MODULE_0__utils_dom__["a"
        /* default */
        ].isFocusableElement()) {
          this.stop();
  ...
  var Grid = function () {
    ...
    _createClass(Grid, [{
      ...
      value: function onKeyPress_(event) {
        if (event.which === __WEBPACK_IMPORTED_MODULE_0__utils_keys__["a"
        /* default */
        ].ENTER) {
  ...
  var Keyboard = function () {
    ...
    _createClass(Keyboard, [{
      ...
      value: function onKeyPress_(event) {
        ...
        if (__WEBPACK_IMPORTED_MODULE_1__utils_dom__["a"
        /* default */
        ].isFocusableElement() || this.ws_.isDisabled()) {
          return;
        }

        switch (event.which) {
          case __WEBPACK_IMPORTED_MODULE_0__utils_keys__["a"
          /* default */
          ].AV_PAGE:
...
function (module, __webpack_exports__, __webpack_require__) {
  ...
  var Navigation = function () {
    ...
    function Navigation(wsInstance) {
      ...
      this.el = __WEBPACK_IMPORTED_MODULE_0__utils_dom__["a"
      /* default */
    ...
    _createClass(Navigation, [{
      ...
      value: function createArrow(id, text) {
        var arrow = __WEBPACK_IMPORTED_MODULE_0__utils_dom__["a"
        /* default */
      ...
      value: function createCounter(id, ws_) {
        var counter = __WEBPACK_IMPORTED_MODULE_0__utils_dom__["a"
        /* default */
        ].createNode('span', id);
...
function (module, __webpack_exports__, __webpack_require__) {
  ...
  var Scroll = function () {
    ...
    function Scroll(wsInstance) {
      ...
      if (!__WEBPACK_IMPORTED_MODULE_0__utils_mobile_detector__["a"
      /* default */
      ].isAny()) {
  ...
  var Touch = function () {
    ...
    function Touch(wsInstance) {
      ...
      /* default */
        ...
        // Likely IE
        if (window.PointerEvent && (__WEBPACK_IMPORTED_MODULE_0__utils_mobile_detector__["a"
        /* default */
        ].isWindows() || __WEBPACK_IMPORTED_MODULE_0__utils_mobile_detector__["a"
        /* default */
        ].isWindowsPhone())) {
...
function (module, __webpack_exports__, __webpack_require__) {
  ...
  var Video = function () {
    ...
    function Video(wsInstance) {
      ...
      var videos = __WEBPACK_IMPORTED_MODULE_0__utils_dom__["a"
      /* default */
      ...
      if (videos.length) {
        videos.forEach(function (video) {
          ...
          var _Slide$getSectionFrom = __WEBPACK_IMPORTED_MODULE_1__modules_slide__["b"
          /* default */
          ...
          slide.video = video;
          slide.el.addEventListener(__WEBPACK_IMPORTED_MODULE_1__modules_slide__["a"
          /* Events */
          ].ENABLE, Video.onSectionEnabled);
          slide.el.addEventListener(__WEBPACK_IMPORTED_MODULE_1__modules_slide__["a"
          /* Events */
          ].DISABLE, Video.onSectionDisabled);
        });
      }
    }
    /**
...
function (module, __webpack_exports__, __webpack_require__) {
  ...
  var Player = function () {
    ...
    function Player(el) {
      ...
      this.slide = __WEBPACK_IMPORTED_MODULE_1__modules_slide__["b"
      /* default */
  ...
  var YouTube = function () {
    ...
    function YouTube(wsInstance) {
      ...
      this.ws_ = wsInstance;
      this.videos = __WEBPACK_IMPORTED_MODULE_0__utils_dom__["a"
      /* default */
    ...
    _createClass(YouTube, [{
      ...
      value: function onYTReady() {
        ...
        this.videos.forEach(function (video) {
          ...
          if (typeof video.dataset.autoplay !== 'undefined') {
            ...
            slide.el.addEventListener(__WEBPACK_IMPORTED_MODULE_1__modules_slide__["a"
            /* Events */
            ].ENABLE, YouTube.onSlideEvent);
            slide.el.addEventListener(__WEBPACK_IMPORTED_MODULE_1__modules_slide__["a"
            /* Events */
            ].DISABLE, YouTube.onSlideEvent);
            slide.el.addEventListener(__WEBPACK_IMPORTED_MODULE_1__modules_slide__["a"
            /* Events */
            ].ENTER, YouTube.onSlideEvent);
            slide.el.addEventListener(__WEBPACK_IMPORTED_MODULE_1__modules_slide__["a"
            /* Events */
            ].LEAVE, YouTube.onSlideEvent);
      ...
      value: function onSlideEvent(event) {
        ...
        switch (event.type) {
          case __WEBPACK_IMPORTED_MODULE_1__modules_slide__["a"
          /* Events */
          ].ENABLE:
            YouTube.onSectionEnabled(slide);
            break;
  ...
  var Zoom = function () {
    ...
    _createClass(Zoom, [{
      ...
      value: function onKeyDown(event) {
        if (!this.isZoomed_ && __WEBPACK_IMPORTED_MODULE_1__utils_keys__["a"
        /* default */
        ].MINUS.some(function (key) {
          return key === event.which;
        })) {
          this.zoomIn();
        } else if (this.isZoomed_ && (__WEBPACK_IMPORTED_MODULE_1__utils_keys__["a"
        /* default */
        ].PLUS.some(function (key) {
          return key === event.which;
        }) || event.which === __WEBPACK_IMPORTED_MODULE_1__utils_keys__["a"
        /* default */
        ].ESCAPE)) {
          this.zoomOut();
        }
      ...
      value: function preBuildZoom_() {
        ...
        this.zws_.el.id = ID;
        this.zws_.wrap = __WEBPACK_IMPORTED_MODULE_0__utils_dom__["a"
        /* default */
        ].createNode('div');
        this.zws_.wrap.className = CLASSES.WRAP_CONTAINER;
        this.zws_.el.appendChild(this.zws_.wrap);
        this.zws_.grid = __WEBPACK_IMPORTED_MODULE_0__utils_dom__["a"
        /* default */
        ].createNode('div');
        ...
        this.zws_.slides = [].map.call(this.ws_.slides, function (slide, i) {
          ...
          return new __WEBPACK_IMPORTED_MODULE_3__modules_slide__["b"
          /* default */
          ](s_, i);
        });
        this.disable();
      ...
      value: function createSlideBlock_(elem) {
        ...
        var wrap = __WEBPACK_IMPORTED_MODULE_0__utils_dom__["a"
        /* default */
        ].wrap(elem.el, 'div');
        ...
        var div = __WEBPACK_IMPORTED_MODULE_0__utils_dom__["a"
        /* default */
        ].wrap(wrap, 'div');

        div.className = CLASSES.DIV; // Adding some layer for controlling click events

        var divLayer = __WEBPACK_IMPORTED_MODULE_0__utils_dom__["a"
        /* default */
        ].createNode('div');
        ...
        var slideNumber = __WEBPACK_IMPORTED_MODULE_0__utils_dom__["a"
        /* default */
      ...
      value: function zoomIn() {
        ...
        setTimeout(function () {
          ...
          Object(__WEBPACK_IMPORTED_MODULE_2__utils_scroll_to__["a"
          /* default */
          ])(actualCurrent.parentNode.offsetTop + __WEBPACK_IMPORTED_MODULE_0__utils_dom__["a"
          /* default */
          ].parseSize(wrapCSS.paddingTop), 50, function () {}, scrollingElement);
        }, 50);
      }
      /**
